...
const PE_SUMMARY = {
  较低: "当前标普500TTM PE为{pe}，PE历史分位为{pct}%，整体估值不高，安全边际相对充足。",
  中等: "当前标普500TTM PE为{pe}，PE历史分位为{pct}%，整体估值处于合理区间。",
  中等偏高: "当前标普500TTM PE为{pe}，PE历史分位为{pct}%，整体不算极端昂贵，但安全边际一般。",
  偏高: "当前标普500TTM PE为{pe}，PE历史分位为{pct}%，整体估值偏贵，需防范估值回归风险。",
};
